...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        connectionsDatabaseReference = FirebaseDatabase.getInstance("https://nutriflow-48394-default-rtdb.firebaseio.com").getReference().child("Connections");
        achievementDatabaseReference = FirebaseDatabase.getInstance("https://nutriflow-48394-default-rtdb.firebaseio.com").getReference().child("Achievements").child(currentUserID);
        ...
        view.findViewById(R.id.relMyDietPlan).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myPlan = new Intent(getActivity(), MyDietPlanActivity.class);
                myPlan.putExtra("intentFrom", "MyProfile");
                myPlan.putExtra("intentUserID", currentUserID);
        ...
        if (intentPurpose.equals("ViewAnotherUserProfile") && !currentUserID.equals(intentUserID)) {
            userDatabaseReference = FirebaseDatabase.getInstance("https://nutriflow-48394-default-rtdb.firebaseio.com").getReference().child("Users").child(intentUserID);
            achievementDatabaseReference = FirebaseDatabase.getInstance("https://nutriflow-48394-default-rtdb.firebaseio.com").getReference().child("Achievements").child(intentUserID);
    ...
    private void OpenRemoveRequestedConnectionConfirmDialog() {
        ...
        yesbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cancelConnectionsDatabaseReference = FirebaseDatabase.getInstance("https://nutriflow-48394-default-rtdb.firebaseio.com").getReference().child("Connections").child(currentUserID).child(intentUserID);
                cancelConnectionsDatabaseReference.removeValue();
                cancelConnectionsDatabaseReference = FirebaseDatabase.getInstance("https://nutriflow-48394-default-rtdb.firebaseio.com").getReference().child("Connections").child(intentUserID).child(currentUserID);
                cancelConnectionsDatabaseReference.removeValue();
                        ...
                        if (accountType.equals("SELL A SERVICE")) {
                            ...
                            if (dataSnapshot.hasChild("userposition")) {
                                ...
                                if (!TextUtils.isEmpty(position)) {
                                    profilePosition.setText(position + " at LogMeal");
