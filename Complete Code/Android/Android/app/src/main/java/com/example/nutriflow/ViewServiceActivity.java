...
public class ViewServiceActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        serviceDatabaseReference = FirebaseDatabase.getInstance("https://nutriflow-48394-default-rtdb.firebaseio.com").getReference().child("Services").child(intentServiceID);
        orderDatabaseReference = FirebaseDatabase.getInstance("https://nutriflow-48394-default-rtdb.firebaseio.com").getReference().child("Orders");
        serviceRatingsDatabaseReference = FirebaseDatabase.getInstance("https://nutriflow-48394-default-rtdb.firebaseio.com").getReference().child("ServiceRatings");
    ...
    private void OpenServiceDeleteConfirmDialog()
    {
        ...
        yesBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                deleteServiceDatabaseReference = FirebaseDatabase.getInstance("https://nutriflow-48394-default-rtdb.firebaseio.com").getReference().child("Services").child(intentServiceID);
